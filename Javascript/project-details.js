...
const services = gsap.utils.toArray(['p', 'h2', 'h3', 'h5', 'h6', '.project-img', 'row', 'button', '.awrds-char', 'h4', '.brands', '.carousel']);
...
/*ScrollTrigger.create({
    snap: 1 / 10 // snap whole page to the closest section!
});*/
